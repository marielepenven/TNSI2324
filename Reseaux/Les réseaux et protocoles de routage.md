...
| **Étape 2 :**<br/>Le protocole IP prend ensuite le relais et « encapsule » ces paquets de données : ce protocole indique la destination des données (datagrammes) grâce à un numéro (adresse IP). | ![](https://github.com/MarieGuichard/TNSI2324/blob/main/Reseaux/IMG/TCP_I_%20img1.jpg)     |
